            ...
            <div className='md:my-10 md:mx-20 flex flex-row relative' >
                <div className='m-8 w-96 mt-16'>
                    ...
                    <div className='py-8 flex flex-col md:flex-row gap-4'>
                        <div className='py-4 px-4 md:py-4 md:px-10 bg-colour hover:cursor-pointer text-center hover:text-colour hover:bg-white hover:border-b-4 border-colour text-white rounded'>Book Ride</div>
