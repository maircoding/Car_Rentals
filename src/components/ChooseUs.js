    ...
    <div className={`my-20 bg-no-repeat bg-[url('./assets/bg.png')]`}>
      ...
      <div className="grid grid-cols-2 mx-20">
        <div className="mx-28 mt-8">
          <h4 className="text-2xl text-bold my-4">Why Choose Us</h4>
          <h1 className="text-5xl text-bold my-4">Best valued deals you will ever find</h1>
          ...
          <div className="bg-red-400 text-white text-bold w-1/3 my-8 py-4 hover:cursor-pointer shadow-lg hover:shadow-red-300 text-center">
            Find Details {`>`}
          </div>
        </div>
